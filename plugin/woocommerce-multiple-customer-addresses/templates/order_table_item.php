<strong style="display:block; clear:both; margin-top: 10px;"><?php _e('Ships to','woocommerce-multiple-customer-addresses'); ?></strong>
<?php 			
...
endforeach; 
	...
	{
		echo '<strong style="display:block; clear:both; margin-top: 10px;">'.__('Notes','woocommerce-multiple-customer-addresses').'</strong>';
		echo $address['notes'];
	}
?>
